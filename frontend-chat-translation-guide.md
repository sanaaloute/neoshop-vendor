...
Successful responses return the resource payload directly.
...
```json
{
  ...
  "details": {
    "fields": [
      { "property": "preferredLanguage", "messages": ["preferredLanguage must be shorter than or equal to 10 characters"] }
    ]
  },
  "path": "/api/v1/...",
  "requestId": "req-uuid",
